...
class Trans4PASS(nn.Module):
    def __init__(self, num_classes=19, emb_chans=128, encoder='trans4pass_v1', norm=None):
        super().__init__()
...
def Trans4PASS_plus_v2(num_classes=19, emb_chans=128, norm=None):
    model = Trans4PASS(num_classes, emb_chans, encoder='trans4pass_v2', norm=norm)
    return model
